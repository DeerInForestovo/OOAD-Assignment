...
import mutiAdapter.MultiAdapter;
...
public class Client2 {
    public static void main(String[] args) {
        ...
        MultiAdapter fileOperator = new MultiAdapter(adaptee, adaptee2);
        Scanner input = new Scanner(System.in);
        System.out.println("Please select operation: 1.readFile 2.listFile 3.write By Name 4.write By Room 5.Add Staff 6.Remove Staff");
        int op = 0;
        do {
            try {
                op = input.nextInt();
